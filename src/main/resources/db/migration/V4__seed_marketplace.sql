...
INSERT INTO utilisateurs (id, nom, prenom, email, telephone, mot_de_passe, role) VALUES
    (6, 'Bennani', 'Omar', 'omar.bennani@test.com', '0666666666', '$2a$10$QFYddcdNGYyRloH9AXP55.Sdq6oIhzACYv8.WVCsQEAOZIkj8VUpe', 'OWNER'),
    (7, 'Berrada', 'Sara', 'sara.berrada@test.com', '0677777777', '$2a$10$QFYddcdNGYyRloH9AXP55.Sdq6oIhzACYv8.WVCsQEAOZIkj8VUpe', 'OWNER'),
    (8, 'Bouskri', 'Mehdi', 'contact@atlascars.ma', '0688888888', '$2a$10$QFYddcdNGYyRloH9AXP55.Sdq6oIhzACYv8.WVCsQEAOZIkj8VUpe', 'OWNER'),
    (9, 'Ouazzani', 'Imane', 'contact@premiumlocation.ma', '0699999999', '$2a$10$QFYddcdNGYyRloH9AXP55.Sdq6oIhzACYv8.WVCsQEAOZIkj8VUpe', 'OWNER'),
    (10, 'Lamrani', 'Youssef', 'youssef.lamrani@test.com', '0610101010', '$2a$10$QFYddcdNGYyRloH9AXP55.Sdq6oIhzACYv8.WVCsQEAOZIkj8VUpe', 'CLIENT');
...
-- =============================================================
INSERT INTO voitures (id, marque, modele, annee, nombre_places, transmission, prix_par_jour, prix_vente, listing_type, statut, owner_id, categorie_id, ville_id) VALUES
    (9,  'Dacia',      'Logan',            2022, 5, 'MANUELLE',     NULL,  95000.00, 'SALE', 'DISPONIBLE', 6, 1, 7),
    (10, 'Renault',    'Clio 5',           2023, 5, 'AUTOMATIQUE', NULL, 145000.00, 'SALE', 'DISPONIBLE', 7, 1, 9),
    (11, 'Peugeot',    '208',              2021, 5, 'MANUELLE',    NULL, 125000.00, 'SALE', 'DISPONIBLE', 6, 1, 8),
    (12, 'Toyota',     'Corolla',          2021, 5, 'AUTOMATIQUE', NULL, 175000.00, 'SALE', 'DISPONIBLE', 7, 2, 1),
    (13, 'Volkswagen', 'Golf 7',           2020, 5, 'MANUELLE',    NULL, 165000.00, 'SALE', 'DISPONIBLE', 8, 2, 2),
    (14, 'Hyundai',    'Tucson',           2022, 5, 'AUTOMATIQUE', NULL, 245000.00, 'SALE', 'DISPONIBLE', 8, 3, 3),
    (15, 'Kia',        'Sportage',         2023, 5, 'AUTOMATIQUE', NULL, 268000.00, 'SALE', 'DISPONIBLE', 9, 3, 6),
    (16, 'Renault',    'Duster',           2021, 5, 'MANUELLE',    NULL, 142000.00, 'SALE', 'DISPONIBLE', 9, 3, 4),
    (17, 'Fiat',       'Doblo',            2022, 5, 'MANUELLE',    NULL, 138000.00, 'SALE', 'DISPONIBLE', 8, 7, 5),
    (18, 'Audi',       'A4',               2019, 5, 'AUTOMATIQUE', NULL, 289000.00, 'SALE', 'INACTIVE',   7, 2, 1),
    (19, 'Ford',       'Transit Connect',  2020, 5, 'MANUELLE',    NULL, 178000.00, 'SALE', 'DISPONIBLE', 6, 7, 12),
    (20, 'BMW',        'X3',               2021, 5, 'AUTOMATIQUE', NULL, 385000.00, 'SALE', 'DISPONIBLE', 9, 3, 1),
    (21, 'Peugeot',    '508',              2022, 5, 'AUTOMATIQUE', NULL, 255000.00, 'SALE', 'DISPONIBLE', 8, 2, 13);
...
-- =============================================================
INSERT INTO voitures (id, marque, modele, annee, nombre_places, transmission, prix_par_jour, prix_vente, listing_type, statut, owner_id, categorie_id, ville_id) VALUES
    (22, 'Dacia',      'Sandero',     2023, 5, 'MANUELLE',     350.00, NULL, 'RENTAL', 'DISPONIBLE',  6, 1, 7),
    (23, 'Hyundai',    'Tucson',      2024, 5, 'AUTOMATIQUE',  650.00, NULL, 'RENTAL', 'DISPONIBLE',  9, 3, 9),
    (24, 'Renault',    'Clio',        2022, 5, 'MANUELLE',     400.00, NULL, 'RENTAL', 'LOUEE',       6, 1, 8),
    (25, 'Volkswagen', 'Polo',        2022, 5, 'MANUELLE',     380.00, NULL, 'RENTAL', 'DISPONIBLE',  7, 1, 1),
    (26, 'Kia',        'Picanto',     2021, 4, 'MANUELLE',     220.00, NULL, 'RENTAL', 'DISPONIBLE',  7, 1, 3),
    (27, 'Dacia',      'Jogger',      2023, 7, 'MANUELLE',     450.00, NULL, 'RENTAL', 'DISPONIBLE',  8, 5, 5),
    (28, 'Peugeot',    '3008',        2023, 5, 'AUTOMATIQUE',  600.00, NULL, 'RENTAL', 'LOUEE',       8, 3, 2),
    (29, 'Toyota',     'RAV4',        2022, 5, 'AUTOMATIQUE',  750.00, NULL, 'RENTAL', 'MAINTENANCE', 9, 3, 6),
    (30, 'Ford',       'Focus',       2021, 5, 'AUTOMATIQUE',  420.00, NULL, 'RENTAL', 'DISPONIBLE',  6, 2, 10),
    (31, 'Renault',    'Captur',      2023, 5, 'MANUELLE',     480.00, NULL, 'RENTAL', 'DISPONIBLE',  7, 1, 11),
    (32, 'Peugeot',    'Partner',     2020, 5, 'MANUELLE',     380.00, NULL, 'RENTAL', 'DISPONIBLE',  8, 7, 4),
    (33, 'Mercedes',   'Classe A',    2022, 5, 'AUTOMATIQUE',  850.00, NULL, 'RENTAL', 'DISPONIBLE',  9, 6, 1),
    (34, 'Seat',       'Ibiza',       2020, 5, 'MANUELLE',     300.00, NULL, 'RENTAL', 'INACTIVE',    6, 1, 14);
